    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <a href="expired-products" class="nav-link"><i class="fas fa-dot"></i><span>Expired Product</span></a>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <a href="pnl" class="nav-link"><i class="fas fa-dot"></i><span>Profit & Loss</span></a>
      ...
      <?php if($getAdmin->usertype == 'u'): ?>

      <li class="dropdown">
        <a href="pos" class="nav-link"><i class="fas fa-calculator"></i><span>Point of Sale</span></a>
      </li>
