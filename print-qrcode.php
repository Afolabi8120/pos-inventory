...
<body>
  ...
  <div class="container-fluid">
    <h2 class="text-center my-4">QR Codes for <?php echo htmlspecialchars(ucwords($fetchProductData->product_name)); ?></h2>
    <div class="row">
        <?php for ($i = 1; $i <= 8; $i++): ?>
            <div class="col-md-3 mb-4">
                <?php echo $admin->generateQRCode($fetchProductData->barcode, ucwords($fetchProductData->product_name), $fetchProductData->selling_price); ?>
                <div class="text-center mt-2">
                    <span><?php echo htmlspecialchars($fetchProductData->barcode); ?></span> 
                </div>
            </div>
        <?php endfor; ?>
    </div>
